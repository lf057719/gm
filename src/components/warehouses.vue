<template>
    <div class="private">
        <h5 class="title">
            <i class="el-icon-share add"></i>入库列表
        </h5>
        <div class="main">
            <div class="p_btn">
                <el-button plain type="primary" icon="el-icon-plus">入库添加</el-button>
                <el-button type="success" icon="el-icon-remove-outline" plain>批量出库</el-button>
